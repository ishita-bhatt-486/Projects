...
const LCD16X2_CfgType LCD16X2_CfgParam[LCD16X2_MAX] =
{
	{   /*  Configuration Parameter For LCD Instance #1   */
		...
		GPIOB,	GPIO_PIN_3, /* LCD D4 Pin GPIO Port & Pin */
		GPIOB,	GPIO_PIN_5, /* LCD D5 Pin GPIO Port & Pin */
		GPIOB,	GPIO_PIN_4, /* LCD D6 Pin GPIO Port & Pin */
		GPIOB,	GPIO_PIN_10, /* LCD D7 Pin GPIO Port & Pin */
		GPIOA,	GPIO_PIN_6, /* LCD EN Pin GPIO Port & Pin */
		GPIOB,	GPIO_PIN_6  /* LCD RS Pin GPIO Port & Pin */
	}
};
